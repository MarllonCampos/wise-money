...
import { Alert, Keyboard, StyleSheet, Text,  
...
export function Login() {
    ...
    return (
        <TouchableWithoutFeedback onPress={async () =>{ console.log(await getInfoOnAsyncStorage());Keyboard.dismiss()}}>

            <LinearGradient
                colors={[Colors.green[900], Colors.green[100]]}
                start={[1, .745]}
                end={[Math.cos(6.252023338460159), Math.sin(6.252023338460159)]}
                locations={[0.2169, .745]}
            ...
            >
                ...
                <View style={styles.form} >
                    ...
                    <InputFloatingLabel 
                        ...
                        textChange={setEmail} 
                    />
                    <InputFloatingLabel label="Senha"
                        style={{marginTop:25}}
                        secure 
                        placeholder='Digite a sua senha' type='default' textChange={setPassword} 
                    />
